...
import type { ReactNode } from "react";   // ← fix: import ReactNode
...
function SectionCard({ children }: { children: ReactNode; }) {  // ← ReactNode not React.ReactNode
    return (
...
export default function Loading() {   // ← must be named "Loading" for Next.js
    return (
